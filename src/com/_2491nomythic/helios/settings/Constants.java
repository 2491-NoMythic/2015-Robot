...
public class Constants {
	...
	public static final int driveTalonFrontCenterChannel = 14;
	public static final int driveTalonFrontRightChannel = 12;
	public static final int driveTalonBackLeftChannel = 11;
	public static final int driveTalonBackCenterChannel = 15;
	public static final int driveTalonBackRightChannel = 13;
	...
	//Arm
	public static final int armTalonArmMotorLeftChannel = 16;
	public static final int armTalonArmMotorRightChannel = 17;
	...
	//Elevator
	public static final int elevatorTalonMotorChannel = 18;
